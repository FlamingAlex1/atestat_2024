...
const finishQuiz = () => {
    ...
    header.parentElement.style.height = "100px";
    if (score == 2) {
        result.innerHTML = `
    ...
    if (score == 4) {
        ...
        <div style="display: flex; flex-direction: column;">
        <strong>Cream</strong>
        <p>La Roche-Posay Cicaplast B5+</p>
        </div>
        </div>
        `;
    }
    if (score == 5) {
        ...
        <div style="display: flex; flex-direction: column; justify-content: center;">
        <strong>Cleanser</strong>
        <p>CeraVe foaming cleansing gel, with ceramides and niacinamide</p>
        </div>
        <div style="display: flex; flex-direction: column;">
        <strong>Cream</strong>
        <p>BEAUTY OF JOSEON Dynasty Face cream</p>
        </div>
        </div>
        `;
    }
    ...
    if (score == 8) {
        ...
        <div style="display: flex; flex-direction: column; justify-content: center;">
        <strong>Cleanser</strong>
        <p>CeraVe anti-imperfection foaming cleansing gel with salicylic acid</p>
        </div>
        <div style="display: flex; flex-direction: column;">
        <strong>Cream</strong>
        <p>Revox Just Acid Salycilic 2%</p>
        </div>
        </div>
        `;
    }
